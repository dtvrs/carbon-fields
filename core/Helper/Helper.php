...
class Helper {
	...
	public function init_scripts() {
		...
		wp_enqueue_script( 'carbon-react', \Carbon_Fields\URL . '/assets/carbon.app.js', array() );
		wp_enqueue_script( 'carbon-boot', \Carbon_Fields\URL . '/assets/carbon.bootstrap.js', array() );
	}
